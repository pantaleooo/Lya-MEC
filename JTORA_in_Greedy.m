...
function [results] = JTORA_in_Greedy(input_para,greedy_action)
...
%     NUM_DEVICE = 30;
    ...
    [~, obj2, ~, ~, ~, ~, ~, ~, ~,~] ...
                = fitness_function(greedy_action, NUM_DEVICE, bandwidth_up, bandwidth_down, compu_task_bit, download_task_bit, channel_gain, bat_level, Bat_level_virt, eh_real, parameter);
    results.best_exec_cost = obj2/input_V;
